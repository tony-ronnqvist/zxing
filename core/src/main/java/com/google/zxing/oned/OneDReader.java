...
public abstract class OneDReader implements Reader {
  ...
  private Result doDecode(BinaryBitmap image,
    ...
    for (int x = 0; x < maxLines; x++) {
      ...
      try {
        Result result =helpDecodingUpsideDown(width, row,hints,rowNumber);
        return result;
  ...
  private Result helpDecodingUpsideDown(int width, BitArray row, Map<DecodeHintType, ?> hints, int rowNumber) throws NotFoundException {
